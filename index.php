    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="https://nnc-media.netralnews.com/IMG-Netral-News-User-6835-A8ZUP6HT7L.jpg" class="img-fluid" width="300" />
          <div>
...
<!-- article end -->
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://api.duniagames.co.id/api/content/upload/file/15695386251674725321.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://cdn.shopify.com/s/files/1/0609/9333/9607/files/e1ac4b3ad01180b05fb0d45b0ffbd420.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://cdn.idntimes.com/content-images/duniaku/post/20230214/fireshot-capture-293-netflix-wwwnetflixcom-d4affeb2610d156a63bb37327a1cc670.png" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://us.oricon-group.com/upimg/sns/1000/1899/img1200/4f7c822e35f349725e612ddb57de3f03.jpg" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://api.duniagames.co.id/api/content/upload/file/4309256041669609369.jpg"
              class="rounded-circle border shadow"
              width="300"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.14942</h3>
            <h1 class="fw-bold">Ilham Adi Nugroho</h1>
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        ...
        ></a>
        <a href="https://wa.me/+6285724292378"
          ><i class="bi bi-whatsapp h2 p-2"></i
        ></a>
      </div>
      <div>Ilham Adi Nugroho &copy; 2023</div>
    </footer>
    <!-- footer end -->
